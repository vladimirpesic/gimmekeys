...
export async function validate(req: Request, res: Response) {
  const { body }: { body: gimmekeysTypes.ValidateLocationPayload } = req
...
export async function create(req: Request, res: Response) {
  const { body }: { body: gimmekeysTypes.LocationName[] } = req
  const names = body
...
export async function update(req: Request, res: Response) {
  ...
  try {
    ...
    if (location) {
      const names: gimmekeysTypes.LocationName[] = req.body
