...
export async function create(req: Request, res: Response) {
  try {
    const { body }: { body: gimmekeysTypes.UpsertBookingPayload } = req
...
export async function book(req: Request, res: Response) {
  try {
    ...
    const { body }: { body: gimmekeysTypes.BookPayload } = req
    const { driver } = body
...
export async function updateStatus(req: Request, res: Response) {
  try {
    const { body }: { body: gimmekeysTypes.UpdateStatusPayload } = req
...
export async function getBookings(req: Request, res: Response) {
  try {
    const { body }: { body: gimmekeysTypes.GetBookingsPayload } = req
