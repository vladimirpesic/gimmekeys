 ...
 * @type {number}
 */
export const PORT = Number.parseInt(__env__('GK_PORT', false, '4002'), 10)
 ...
 * @type {boolean}
 */
export const HTTPS = Helper.StringToBoolean(__env__('GK_HTTPS'))
 ...
 * @type {string}
 */
export const PRIVATE_KEY = __env__('GK_PRIVATE_KEY', HTTPS)
 ...
 * @type {string}
 */
export const CERTIFICATE = __env__('GK_CERTIFICATE', HTTPS)

/**
 * MongoDB database URI. Default is: mongodb://127.0.0.1:27017/gimmekeys?authSource=admin&appName=gimmekeys
 *
 * @type {string}
 */
export const DB_URI = __env__('GK_DB_URI', false, 'mongodb://127.0.0.1:27017/gimmekeys?authSource=admin&appName=gimmekeys')
 ...
 * @type {boolean}
 */
export const DB_SSL = Helper.StringToBoolean(__env__('GK_DB_SSL', false, 'false'))
 ...
 * @type {string}
 */
export const DB_SSL_CERT = __env__('GK_DB_SSL_CERT', DB_SSL)
 ...
 * @type {string}
 */
export const DB_SSL_CA = __env__('GK_DB_SSL_CA', DB_SSL)
 ...
 * @type {boolean}
 */
export const DB_DEBUG = Helper.StringToBoolean(__env__('GK_DB_DEBUG', false, 'false'))
 ...
 * @type {string}
 */
export const COOKIE_SECRET = __env__('GK_COOKIE_SECRET', false, 'GimmeKeys')
 ...
 * @type {string}
 */
export const AUTH_COOKIE_DOMAIN = __env__('GK_AUTH_COOKIE_DOMAIN', false, 'localhost')
 ...
 *
 * @type {"gk-x-access-token-frontend"}
 */
export const FRONTEND_AUTH_COOKIE_NAME = 'gk-x-access-token-frontend'
 ...
 * @type {"gk-x-access-token-frontend"}
 */
export const BACKEND_AUTH_COOKIE_NAME = 'gk-x-access-token-backend'
 ...
 * @type {string}
 */
export const JWT_SECRET = __env__('GK_JWT_SECRET', false, 'GimmeKeys')
 ...
 * @type {number}
 */
export const JWT_EXPIRE_AT = Number.parseInt(__env__('GK_JWT_EXPIRE_AT', false, '86400'), 10)
 ...
 * @type {number}
 */
export const TOKEN_EXPIRE_AT = Number.parseInt(__env__('GK_TOKEN_EXPIRE_AT', false, '86400'), 10)
 ...
 * @type {string}
 */
export const SMTP_HOST = __env__('GK_SMTP_HOST', true)
 ...
 * @type {number}
 */
export const SMTP_PORT = Number.parseInt(__env__('GK_SMTP_PORT', true), 10)
 ...
 * @type {string}
 */
export const SMTP_USER = __env__('GK_SMTP_USER', true)
 ...
 * @type {string}
 */
export const SMTP_PASS = __env__('GK_SMTP_PASS', true)
 ...
 * @type {string}
 */
export const SMTP_FROM = __env__('GK_SMTP_FROM', true)
 ...
 * @type {string}
 */
export const CDN_USERS = __env__('GK_CDN_USERS', true)
 ...
 * @type {string}
 */
export const CDN_TEMP_USERS = __env__('GK_CDN_TEMP_USERS', true)
 ...
 * @type {string}
 */
export const CDN_CARS = __env__('GK_CDN_CARS', true)
 ...
 * @type {string}
 */
export const CDN_TEMP_CARS = __env__('GK_CDN_TEMP_CARS', true)
 ...
 * @type {string}
 */
export const BACKEND_HOST = __env__('GK_BACKEND_HOST', true)
 ...
 * @type {string}
 */
export const FRONTEND_HOST = __env__('GK_FRONTEND_HOST', true)
 ...
 * @type {string}
 */
export const DEFAULT_LANGUAGE = __env__('GK_DEFAULT_LANGUAGE', false, 'en')
 ...
 * @type {number}
 */
export const MINIMUM_AGE = Number.parseInt(__env__('GK_MINIMUM_AGE', false, '21'), 10)
 ...
 * @type {string}
 */
export const EXPO_ACCESS_TOKEN = __env__('GK_EXPO_ACCESS_TOKEN', false)
...
export interface Car extends Document {
    ...
    deposit: number
    available: boolean
    type: gimmekeysTypes.CarType
    gearbox: gimmekeysTypes.GearboxType
    aircon: boolean
    image: string | null
    seats: number
    doors: number
    fuelPolicy: gimmekeysTypes.FuelPolicy
    mileage: number
    cancellation: number
    amendments: number
