...
const carSchema = new Schema<env.Car>(
  {
    ...
    type: {
      type: String,
      enum: [gimmekeysTypes.CarType.Diesel, gimmekeysTypes.CarType.Gasoline],
      required: [true, "can't be blank"],
    },
    gearbox: {
      type: String,
      enum: [gimmekeysTypes.GearboxType.Manual, gimmekeysTypes.GearboxType.Automatic],
      required: [true, "can't be blank"],
    },
    aircon: {
      type: Boolean,
    ...
    fuelPolicy: {
      type: String,
      enum: [gimmekeysTypes.FuelPolicy.LikeForlike, gimmekeysTypes.FuelPolicy.FreeTank],
      required: [true, "can't be blank"],
    },
    mileage: {
      type: Number,
