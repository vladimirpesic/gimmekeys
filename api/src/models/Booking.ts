...
const bookingSchema = new Schema<env.Booking>(
  {
    ...
    status: {
      type: String,
      enum: [
        gimmekeysTypes.BookingStatus.Void,
        gimmekeysTypes.BookingStatus.Pending,
        gimmekeysTypes.BookingStatus.Deposit,
        gimmekeysTypes.BookingStatus.Paid,
        gimmekeysTypes.BookingStatus.Reserved,
        gimmekeysTypes.BookingStatus.Cancelled,
      ],
      required: [true, "can't be blank"],
    },
    cancellation: {
