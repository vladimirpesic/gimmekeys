 ...
 */
export const getNotificationCounter = async (userId: string): Promise<gimmekeysTypes.NotificationCounter> => {
 ...
 */
export const getNotifications = async (userId: string, page: number): Promise<gimmekeysTypes.Result<gimmekeysTypes.Notification>> => {
  const headers = await UserService.authHeader()
  return axios
    .get(
