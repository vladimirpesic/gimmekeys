 ...
 * Sign up.
 *
 * @param {gimmekeysTypes.FrontendSignUpPayload} data
 * @returns {Promise<number>}
 */
export const signup = (data: gimmekeysTypes.FrontendSignUpPayload): Promise<number> =>
  axios
    .post(
 ...
 * @returns {Promise<number>}
 */
export const activate = async (data: gimmekeysTypes.ActivatePayload): Promise<number> => {
 ...
 */
export const signin = async (data: gimmekeysTypes.SignInPayload): Promise<{ status: number, data: gimmekeysTypes.User }> =>
  axios
    .post(
    ...
    .then(async (res) => {
      if (res.data.accessToken) {
        await AsyncStorage.storeObject('gk-user', res.data)
      }
...
export const signout = async (
  ...
  await AsyncStorage.removeItem('gk-user')
 ...
 * @returns {Promise<number>}
 */
export const resendLink = async (data: gimmekeysTypes.ResendLinkPayload): Promise<number> => {
  const headers = await authHeader()
  return axios
    .post(
...
export const getLanguage = async () => {
  const user = await AsyncStorage.getObject<gimmekeysTypes.User>('gk-user')

  if (user && user.language) {
    return user.language
  }
  let lang = await AsyncStorage.getString('gk-language')
 ...
 * @returns {unknown}
 */
export const updateLanguage = async (data: gimmekeysTypes.UpdateLanguagePayload) => {
  const headers = await authHeader()
  return axios.post(`${Env.API_HOST}/api/update-language`, data, { headers }).then(async (res) => {
    if (res.status === 200) {
      ...
      if (user) {
        ...
        await AsyncStorage.storeObject('gk-user', user)
      } else {
        ToastHelper.error()
      }
    }
...
export const setLanguage = async (lang: string) => {
  await AsyncStorage.storeString('gk-language', lang)
}
 ...
 */
export const getUser = async (id: string): Promise<gimmekeysTypes.User> => {
  const headers = await authHeader()
  return axios
 ...
 * @returns {Promise<number>}
 */
export const updateUser = async (data: gimmekeysTypes.UpdateUserPayload): Promise<number> => {
  const headers = await authHeader()
  return axios
    .post(
 ...
 * @returns {Promise<number>}
 */
export const updateEmailNotifications = async (data: gimmekeysTypes.UpdateEmailNotificationsPayload): Promise<number> => {
  const headers = await authHeader()
  return axios
    .post(
 ...
 * @returns {Promise<number>}
 */
export const changePassword = async (data: gimmekeysTypes.ChangePasswordPayload): Promise<number> => {
  const headers = await authHeader()
  return axios
    .post(
