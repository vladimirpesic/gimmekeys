...
function DateTimePicker({
  ...
  useEffect(() => {
    ...
    setLoacle(_locale)
    setLabel((value && gimmekeysHelper.capitalize(format(value, _format, { locale: _locale }))) || dateTimeLabel)
  }, [dateTimeLocale]) // eslint-disable-line react-hooks/exhaustive-deps

  useEffect(() => {
    setValue(dateTimeValue)
    setLabel((dateTimeValue && gimmekeysHelper.capitalize(format(dateTimeValue, _format, { locale }))) || dateTimeLabel)
