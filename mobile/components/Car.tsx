    ...
    <View key={car._id} style={styles.carContainer}>
      <View style={styles.car}>
        ...
        <View style={styles.imgView}>
          <Image style={styles.img} source={{ uri: gimmekeysHelper.joinURL(Env.CDN_CARS, car.image) }} />
        </View>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.price}>
            <Text style={styles.priceSecondary}>{Helper.getDays(gimmekeysHelper.days(from, to))}</Text>
            <Text style={styles.pricePrimary}>{`${gimmekeysHelper.formatNumber(Helper.price(car, from, to))} ${i18n.t('CURRENCY')}`}</Text>
            <Text style={styles.priceSecondary}>{`${i18n.t('PRICE_PER_DAY')} ${gimmekeysHelper.formatNumber(car.price)} ${i18n.t('CURRENCY')}`}</Text>
          </View>
        </View>
