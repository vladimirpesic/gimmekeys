 ...
 *
 * @param {?(gimmekeysTypes.Filter | null)} [a]
 * @param {?(gimmekeysTypes.Filter | null)} [b]
 * @returns {boolean}
 */
export declare const filterEqual: (a?: gimmekeysTypes.Filter | null, b?: gimmekeysTypes.Filter | null) => boolean;
/**
 * Flatten Supplier array.
 *
 * @param {gimmekeysTypes.User[]} companies
 * @returns {string[]}
 */
export declare const flattenCompanies: (companies: gimmekeysTypes.User[]) => string[];
/**
