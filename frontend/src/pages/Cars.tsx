...
function Cars() {
  ...
  const handleCarFilterSubmit = (filter: gimmekeysTypes.CarFilter) => {
  ...
  const handleFuelFilterChange = (values: gimmekeysTypes.CarType[]) => {
    setFuel(values)
  }

  const handleGearboxFilterChange = (values: gimmekeysTypes.GearboxType[]) => {
    setGearbox(values)
  }

  const handleMileageFilterChange = (values: gimmekeysTypes.Mileage[]) => {
    setMileage(values)
  }
  ...
  const onLoad = async (user?: gimmekeysTypes.User) => {
