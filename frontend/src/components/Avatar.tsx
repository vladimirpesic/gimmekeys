...
interface AvatarProps {
  ...
  className?: string,
  onBeforeUpload?: () => void,
  onChange?: (user: gimmekeysTypes.User) => void,
}
  ...
  return !error && loggedUser && user ? (
    <div className={className}>
      {loggedUser._id === user._id && !readonly ? (
        <div>
          ...
          {user.avatar ? (
            ...
            >
              ...
              >
                <MaterialAvatar src={gimmekeysHelper.joinURL(Env.CDN_USERS, user.avatar)} className="avatar" />
              </Badge>
            </Badge>
          ) : (
            <Badge
        ...
        <MaterialAvatar src={gimmekeysHelper.joinURL(Env.CDN_USERS, user.avatar)} className={size ? `avatar-${size}` : 'avatar'} />
      ) : (
