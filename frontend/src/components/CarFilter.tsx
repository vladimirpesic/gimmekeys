...
interface CarFilterProps {
  from: Date
  to: Date
  pickupLocation: gimmekeysTypes.Location
  dropOffLocation: gimmekeysTypes.Location
  className?: string
  onSubmit: gimmekeysTypes.CarFilterSubmitEvent
}
...
function CarFilter({
  ...
  const [pickupLocation, setPickupLocation] = useState<gimmekeysTypes.Location | null | undefined>(filterPickupLocation)
  const [dropOffLocation, setDropOffLocation] = useState<gimmekeysTypes.Location | null | undefined>(filterDropOffLocation)
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (onSubmit) {
      const filter: gimmekeysTypes.CarFilter = {
      ...
      <form onSubmit={handleSubmit} className="home-search-form">
        <FormControl fullWidth className="pickup-location">
          <LocationSelectList
            ...
            required
            variant="standard"
            value={pickupLocation as gimmekeysTypes.Location}
        ...
        {!sameLocation && (
          <FormControl fullWidth className="drop-off-location">
            <LocationSelectList
              ...
              value={dropOffLocation as gimmekeysTypes.Location}
              hidePopupIcon
              customOpen
              required
              variant="standard"
