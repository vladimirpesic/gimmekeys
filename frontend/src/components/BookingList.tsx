        ...
        renderCell: ({ row }: GridRenderCellParams<gimmekeysTypes.Booking>) => {
          ...
          return (
            <>
              ...
              {row.cancellation
                && !row.cancelRequest
                && row.status !== gimmekeysTypes.BookingStatus.Cancelled
    ...
    <div className="bs-list">
      {user
        && (rows.length === 0 ? (
          ...
          <>
            {rows.map((booking) => {
              const _bookingCar = booking.car as gimmekeysTypes.Car
              const bookingSupplier = booking.company as gimmekeysTypes.User
              ...
              return (
                <div key={booking._id} className="booking-details">
                  ...
                  <div className="booking-detail" style={{ height: bookingDetailHeight }}>
                    ...
                    <div className="booking-detail-value">{`${_bookingCar.name} (${gimmekeysHelper.formatNumber(_bookingCar.price)} ${csStrings.CAR_CURRENCY})`}</div>
                  </div>
                  <div className="booking-detail" style={{ height: bookingDetailHeight }}>
                  ...
                  <div className="booking-detail" style={{ height: bookingDetailHeight }}>
                    ...
                    <div className="booking-detail-value">
                      <div className="car-company">
                        <img src={gimmekeysHelper.joinURL(Env.CDN_USERS, bookingSupplier.avatar)} alt={bookingSupplier.fullName} />
