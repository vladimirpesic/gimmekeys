...
function Company() {
  ...
  const [company, setCompany] = useState<gimmekeysTypes.User>()
  ...
  const edit = user && company && (user.type === gimmekeysTypes.RecordType.Admin || user._id === company._id)
              ...
              {edit ? (
                ...
                <div className="car-company">
                  <span className="car-company-logo">
                    <img src={gimmekeysHelper.joinURL(Env.CDN_USERS, company.avatar)} alt={company.fullName} style={{ width: Env.COMPANY_IMAGE_WIDTH }} />
                  </span>
