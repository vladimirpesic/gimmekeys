...
function User() {
  ...
  const edit = loggedUser && user && (loggedUser.type === gimmekeysTypes.RecordType.Admin || loggedUser._id === user._id || (loggedUser.type === gimmekeysTypes.RecordType.Company && loggedUser._id === user.company))
  const company = user && user.type === gimmekeysTypes.RecordType.Company
