...
function Cars() {
  ...
  const [gearbox, setGearbox] = useState<string[]>([gimmekeysTypes.GearboxType.Automatic, gimmekeysTypes.GearboxType.Manual])
  const [fuel, setFuel] = useState<string[]>([gimmekeysTypes.CarType.Diesel, gimmekeysTypes.CarType.Gasoline])
  const [mileage, setMileage] = useState<string[]>([gimmekeysTypes.Mileage.Limited, gimmekeysTypes.Mileage.Unlimited])
  const [availability, setAvailability] = useState<string[]>([gimmekeysTypes.Availablity.Available, gimmekeysTypes.Availablity.Unavailable])
  ...
  const handleCarListLoad: gimmekeysTypes.DataEvent<gimmekeysTypes.Car> = (data) => {
    if (data) {
